...
public class MultiSpinnerSearch extends AppCompatSpinner implements DialogInterface.OnCancelListener {
    ...
    ArrayList<BrandMaster> rsplist = new ArrayList<>();
    ...
    public void onCancel(DialogInterface dialog) {
        ...
        for (int i = 0; i < rsplist.size(); i++) {
            if (rsplist.get(i).isSelected()) {
                spinnerBuffer.append(rsplist.get(i).getBrand());
    ...
    public void setItems(ArrayList<BrandMaster> items, int position, SpinnerListener listener) {
        this.rsplist = items;
        ...
        for (int i = 0; i < items.size(); i++) {
            if (items.get(i).isSelected()) {
                spinnerBuffer.append(items.get(i).getBrand());
                spinnerBuffer.append(", ");
            }
        }
    ...
    public class MultipleSelectionSpinAdapter extends BaseAdapter {
        ...
        ArrayList<BrandMaster> mOriginalValues; // Original Values
