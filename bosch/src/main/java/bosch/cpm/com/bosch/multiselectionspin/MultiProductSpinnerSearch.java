...
public class MultiProductSpinnerSearch extends AppCompatSpinner implements DialogInterface.OnCancelListener {
    private static final String TAG = MultiSpinnerSearch.class.getSimpleName();
    private String defaultText = "";
    private String spinnerTitle = "";
    private ProductSpinnerListener listener;
    private int limit = -1;
    private int selected = 0;
    MultipleSelectionSpinAdapter adapter;
    ArrayList<CategoryMaster> productList=new ArrayList<>();
    public static AlertDialog ad;
    Context context;
    public MultiProductSpinnerSearch(Context context) {
        super(context);
    }

    public MultiProductSpinnerSearch(Context arg0, AttributeSet arg1) {
        super(arg0, arg1);
    ...
    public MultiProductSpinnerSearch(Context arg0, AttributeSet arg1, int arg2) {
    ...
    public void onCancel(DialogInterface dialog) {
        ...
        listener.onItemsSelectedProduct(productList);
    }
    ...
    public void setItemsProduct(ArrayList<CategoryMaster> items, int position, ProductSpinnerListener listener) {
        this.productList = items;
        this.listener = (ProductSpinnerListener) listener;
        StringBuilder spinnerBuffer = new StringBuilder();
    ...
    public class MultipleSelectionSpinAdapter extends BaseAdapter {
        ...
        ArrayList<CategoryMaster> arrayList;
        ArrayList<CategoryMaster> mOriginalValues; // Original Values
        LayoutInflater inflater;

        public MultipleSelectionSpinAdapter(Context context, ArrayList<CategoryMaster> arrayList) {
        ...
        public View getView(final int position, View convertView, ViewGroup parent) {
            ...
            final CategoryMaster data = arrayList.get(position);
