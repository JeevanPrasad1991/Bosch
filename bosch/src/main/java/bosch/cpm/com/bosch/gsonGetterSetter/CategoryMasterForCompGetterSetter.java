...
public class CategoryMasterForCompGetterSetter {
    ...
    public boolean equals(Object obj) {
        ...
        if (!(obj instanceof CategoryMasterForCompGetterSetter)) {
            return false;
        }

        CategoryMasterForCompGetterSetter other = (CategoryMasterForCompGetterSetter) obj;
        return this.getBrand_Id().equals(other.getBrand_Id()) && this.getPromoType_Id().equals(other.getPromoType_Id());
    }

    @Override
    public int hashCode() {
        // return super.hashCode();
        return getBrand_Id().hashCode();
    }
}
